...
class UserDataControllerTest < ActionController::TestCase
  ...
  test "should create user_datum" do
    assert_difference('UserDatum.count') do
      post :create, user_datum: { deviceid: @user_datum.deviceid, location: @user_datum.location, time: @user_datum.time }
    end
  ...
  test "should update user_datum" do
    put :update, id: @user_datum, user_datum: { deviceid: @user_datum.deviceid, location: @user_datum.location, time: @user_datum.time }
    assert_redirected_to user_datum_path(assigns(:user_datum))
  end
