...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { rank: @station.rank, stationId: @station.stationId, upordown: @station.upordown }
    end
  ...
  test "should update station" do
    put :update, id: @station, station: { rank: @station.rank, stationId: @station.stationId, upordown: @station.upordown }
    assert_redirected_to station_path(assigns(:station))
  end
